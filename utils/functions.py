...
class SavePath:
    ...
    def __init__(self, model_name:str, iteration:int):
    ...
    def get_path(self, root:str=''):
        ...
        file_name = self.model_name + '_' + str(self.iteration) + '.pth'
    ...
    def from_str(path:str):
        ...
        model_name = '_'.join(params[:-1])
        iteration = params[-1]
        
        return SavePath(model_name, int(iteration))
