...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='weights/yolact_base_16351_32702.pth', type=str,
    ...
    parser.add_argument('--display_bboxes', default=None, type=str2bool,
                        help='Whether or not to display bboxes around masks')
    parser.add_argument('--display_text', default=None, type=str2bool,
    ...
    parser.add_argument('--images', default='./data/input:./data/output', type=str,
