from Yolact_res101.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
CUSTOM_CLASSES = ('building', 'farm', 'forest', 'vh-white', 'vh-black', 'river')
...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': './Yolact_res101/data/geoai/train/images/',
    'train_info':   './Yolact_res101/data/geoai/train/via_region_coco.json',

    'valid_images': './Yolact_res101/data/geoai/test/images/',
    'valid_info':   './Yolact_res101/data/geoai/test/via_region_coco.json',

    'has_gt': True,
    'class_names': ('building', 'farm', 'vh', 'crosswalk', 'safezone'),
})
...
coco_base_config = Config({
    ...
    'augment_random_rot180': False,
    'augment_random_rot270': False,
